...
/**
 * Modelklasse zur Registrierung und Authentifizierung von Accounts
 */
class DragonX_Account_Model_Account extends DragonX_Database_Model_Abstract
{
    /**
    ...
    {
        return $this->_insert(
            'dragonx_account_accounts',
            array('identity' => $identity, 'credential' => $credential)
        );
    }
